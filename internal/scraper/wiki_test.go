		...
		},
		{
			...
			want: models.Calendar{
				January: map[uint8][]models.Release{
					12: {
						{Artist: "Emil Bulls", Album: "Love Will Fix It"},
						{Artist: "Exit Eden", Album: "Femmes Fatales"},
						{Artist: "Project 86", Album: "OMNI, Pt. 2"},
						{Artist: "The Rods", Album: "Rattle the Cage"},
						{Artist: "Russell / Guns", Album: "Medusa"},
						{Artist: "Scanner", Album: "The Cosmic Race"},
					},
					19: {
						{Artist: "Master", Album: "Saints Dispelled"},
						{Artist: "Saxon", Album: "Hell, Fire and Damnation"},
					},
					26: {
						{Artist: "Any Given Day", Album: "Limitless"},
						{Artist: "Caligula's Horse", Album: "Charcoal Grace"},
						{Artist: "Inquisition", Album: "Veneration of Medieval Mysticism and Cosmological Violence"},
						{Artist: "Kill the Thrill", Album: "Autophagie"},
						{Artist: "Lucifer", Album: "Lucifer V"},
						{Artist: "Madder Mortem", Album: "Old Eyes, New Heart"},
						{Artist: "Mägo de Oz", Album: "Alicia en el Metalverso"},
						{Artist: "Manticora", Album: "Mycelium"},
						{Artist: "Static-X", Album: "Project: Regeneration Vol. 2"},
						{Artist: "Whitechapel", Album: "Live in the Valley (live album)"},
					},
				},
				February: map[uint8][]models.Release{
					2: {
						{Artist: "Artillery", Album: "Raw Live (At Copenhell) (live album)"},
						{Artist: "Enterprise Earth", Album: "Death: An Anthology"},
						{Artist: "Ghoul", Album: "Noxious Concoctions (EP)"},
						{Artist: "Myrath", Album: "Karma"},
						{Artist: "Necrowretch", Album: "Swords of Dajjal"},
						{Artist: "Persefone", Album: "Lingua Ignota: Part I (EP)"},
					...
					9: {
						...
						{Artist: "The Last Ten Seconds of Life", Album: "No Name Graves"},
						{Artist: "Les Claypool", Album: "Adverse Yaw: The Prawn Song Years (box set)"},
						{Artist: "Morbid Saint", Album: "Swallowed by Hell"},
						{Artist: "Per Wiberg", Album: "The Serpent's Here"},
					},
					16: {
						{Artist: "Ihsahn", Album: "Ihsahn"},
						{Artist: "The Obsessed", Album: "Gilded Sorrow"},
						{Artist: "Riot V", Album: "Mean Streets"},
						{Artist: "See You Next Tuesday", Album: "Relapses (remix album)"},
					},
					23: {
						{Artist: "Ace Frehley", Album: "10,000 Volts"},
						{Artist: "Amaranthe", Album: "The Catalyst"},
						{Artist: "Austrian Death Machine", Album: "Quad Brutal"},
						{Artist: "Borknagar", Album: "Fall"},
						{Artist: "Darkest Hour", Album: "Perpetual I Terminal"},
						{Artist: "Job for a Cowboy", Album: "Moon Healer"},
						{Artist: "Lionheart", Album: "The Grace of a Dragonfly"},
						{Artist: "Mick Mars", Album: "The Other Side of Mars"},
					},
				},
				March: map[uint8][]models.Release{
					1: {
						{Artist: "Blind Channel", Album: "Exit Emotions"},
						{Artist: "Bruce Dickinson", Album: "The Mandrake Project"},
						{Artist: "Firewind", Album: "Stand United"},
						{Artist: "Messiah", Album: "Christus Hypercubus"},
						{Artist: "Ministry", Album: "Hopiumforthemasses"},
						{Artist: "New Years Day", Album: "Half Black Heart"},
						{Artist: "Suicidal Angels", Album: "Profane Player"},
					},
					8: {
						{Artist: "Judas Priest", Album: "Invincible Shield"},
						{Artist: "Sonata Arctica", Album: "Clear Cold Beyond"},
					},
					15: {
						{Artist: "DragonForce", Album: "Warp Speed Warriors"},
						{Artist: "Necrophobic", Album: "In the Twilight Grey"},
						{Artist: "Scott Stapp", Album: "Higher Power"},
					},
					22: {
						{Artist: "Alestorm", Album: "Voyage of the Dead Marauder (EP)"},
					},
					29: {
						{Artist: "Rage", Album: "Afterlifelines"},
						{Artist: "Sum 41", Album: "Heaven :x: Hell"},
						{Artist: "While She Sleeps", Album: "Self Hell"},
					},
				},
				April: map[uint8][]models.Release{
					5: {
						{Artist: "Korpiklaani", Album: "Rankarumpu"},
					},
				},
				May:       nil,
				June:      nil,
