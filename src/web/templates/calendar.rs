...
use crate::{
    ...
    web::{handlers_calendar::CalendarDay, templates::core::head},
};
                ...
                div class="flex  items-center justify-between gap-3 mb-5" {
                  ...
                  div class="hidden md:flex items-center gap-3 " {
                    div class="flex items-center gap-2" {
                      ...
                      span class="w-px h-7 bg-gray-200" {}
                      button class="p-3 text-gray-500 flex items-center justify-center transition-all duration-300 hover:text-gray-900" {
                        svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" {
                          ...
                          path d="M12.68 10.3947C12.68 11.8481 11.4794 13.0263 9.99834 13.0263C8.5173 13.0263 7.31668 11.8481 7.31668 10.3947C7.31668 8.94136 8.5173 7.76316 9.99834 7.76316C11.4794 7.76316 12.68 8.94136 12.68 10.3947Z" stroke="currentcolor" stroke-width="1.3" {}
                        }
                      }
                    }
                    div class="flex items-center gap-px p-1 rounded-md bg-gray-100" {
                      button class="py-2.5 px-5 rounded-lg bg-gray-100 text-sm font-medium text-gray-900 transition-all duration-300 hover:bg-white" { "Day" }
                      button class="py-2.5 px-5 rounded-lg bg-white text-sm font-medium text-gray-900 transition-all duration-300 hover:bg-white" {"Week"}
                      button class="py-2.5 px-5 rounded-lg bg-gray-100 text-sm font-medium text-gray-900 transition-all duration-300 hover:bg-white" {"Month"}
                    }
                  }
                  div class="dropdown relative inline-flex md:hidden" {
                    button type="button" data-target="dropdown-default" class="dropdown-toggle inline-flex justify-center items-center gap-2 py-1.5 px-2.5 text-sm bg-gray-50 text-gray-900 rounded-full cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 hover:bg-gray-100 " {
                      svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" {
                        path d="M3 3H21M3 15H21M7 9H16.5M7 21H16.5" stroke="currentcolor" stroke-width="1.6" stroke-linecap="round" {}
                      }
                    ...
                    div id="dropdown-default" class="dropdown-menu rounded-xl shadow-lg bg-white absolute top-full w-max -left-20 mt-2 open" aria-labelledby="dropdown-default" {
                      ul class="py-2" {
                        li {
                        ...
                        li class="bg-gray-300 w-full h-px" {}
                        li {
                          a class="block px-6 py-2 hover:bg-gray-100 text-gray-600 font-medium" href="javascript:;" {
                            "Viwe Day"
                          }
                  ...
                  div class="grid grid-cols-7  divide-gray-200 border-b border-gray-200" {
                    @for weekday in weekdays {
                      div class="p-3.5 flex flex-col sm:flex-row items-center justify-between border-r border-gray-200" {
                        span class="text-sm font-medium text-gray-500" { (weekday) }
                      }
                    }
                  }
                  ...
                  div class="bg-gray-50 w-full rounded-xl" {
                    div class="p-3 w-full flex items-center justify-between group transition-all duration-300" {
                      div class="flex flex-col gap-2" {
                        span class="text-sm font-medium text-gray-900" { "Meet with friends" }
                        div class="flex items-center gap-2.5" {
                          svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" {
                            path d="M12 8.99998V13L15 16M3 5.12132L5.10714 3M20.998 5.12657L18.8909 3.00525M20 13C20 17.4183 16.4183 21 12 21C7.58172 21 4 17.4183 4 13C4 8.5817 7.58172 4.99998 12 4.99998C16.4183 4.99998 20 8.5817 20 13Z" stroke="black" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" {}
                          }
                          span class="text-xs font-medium text-gray-600" { "9AM" }
                        }
                      }
                      button class="py-1 px-2 rounded border border-gray-400 text-xs font-medium text-gray-900 opacity-0 transition-all duration-500 group-hover:opacity-100" { "Edit" }
                    }
                  }
                }
              }
